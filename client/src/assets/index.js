...
import cross_icon from './imgs/cross_icon.svg'
import upload_area from './imgs/upload_area.svg'
import sketch from './imgs/sketch.svg'
...
import star from './imgs/rating_star.svg'
import star_blank from './imgs/star_dull_icon.svg'
...
import arrow_icon from './imgs/arrow_icon.svg'
import down_arrow_icon from './imgs/down_arrow_icon.svg'
import time_left_clock_icon from './imgs/time_left_clock_icon.svg'
import time_clock_icon from './imgs/time_clock_icon.svg'
import user_icon from './imgs/user_icon.svg'
import home_icon from './imgs/home_icon.svg'
import add_icon from './imgs/add_icon.svg'
import my_course_icon from './imgs/my_course_icon.svg'
import person_tick_icon from './imgs/person_tick_icon.svg'
import facebook_icon from './imgs/facebook_icon.svg'
import instagram_icon from './imgs/instagram_icon.svg'
import twitter_icon from './imgs/twitter_icon.svg'
...
import dropdown_icon from './imgs/dropdown_icon.svg'
import patients_icon from './imgs/patients_icon.svg'
import play_icon from './imgs/play_icon.svg'
import blue_tick_icon from './imgs/blue_tick_icon.svg'
...
import lesson_icon from './imgs/lesson_icon.svg'
...
export const dummyCourses = [
    ...
    },
    {
        ...
        "courseTitle": "Data Science with Python",
        "courseDescription": "<h4>Start Your Data Science Journey</h2><p>Data Science is one of the most in-demand fields in the world. This course teaches you the essentials of data analysis, visualization, and machine learning using Python. Learn libraries like Pandas, NumPy, Matplotlib, and Scikit-learn.</p><p>By the end of this course, you will be equipped to work on real-world data projects and gain insights from data.</p><ul><li>Data cleaning and preprocessing</li><li>Exploratory Data Analysis (EDA)</li><li>Build predictive models</li></ul>",
        "coursePrice": 89.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
    ...
    },
    {
        ...
        "courseDescription": "<h4>Unlock the Power of Data</h2><p>This course provides a comprehensive introduction to data science and machine learning. You will learn how to analyze data, build predictive models, and apply machine learning algorithms to real-world problems.</p><p>By the end of this course, you will have a solid understanding of data manipulation, visualization, and machine learning techniques, enabling you to make data-driven decisions.</p><ul><li>Understand data analysis and visualization</li><li>Learn machine learning algorithms and their applications</li><li>Work with popular data science libraries like Pandas and Scikit-Learn</li></ul>",
        "coursePrice": 89.99,
        "isPublished": true,
        "discount": 30,
        "courseContent": [
